...
/*
ExercÌcio 1:
    Crie um programa que converta uma lista de n˙meros inteiros em seus respectivos cÛdigos ASCII.
    ApÛs, imprima o texto resultante.
    OBS: Pode ser ˙til consultar a tabela ASCII:
...
ExercÌcio 2:
    Sendo o limite de 22.5 kg para cada mala no aeroporto, dados trÍs pesos de malas,
    escreva a frase apropriada para cada um dos casos.
    Menor que 22.5:     Peso abaixo do limite.
    Igual a 22.5:       Peso m·ximo atingido.
    Maior que 22.5:     Excesso de peso, haver· cobranÁa de adicional.

	Casos de teste:
	    Float peso1 = Float.valueOf("22.5");    // Peso m·ximo
...
public class exercicioWrapper {
    ...
    private static void exercicio1() {
        ...
        for (int i = 0; i < numeros.length; i++) {
            ...
            //int ascii = numeros[i];
            // usei de CAST "(char)": forÁei o tipo CHAR e o java converteu o int para a letra
    ...
    public static String obtemSituacaoBagagem(Float peso){
        ...
        if(peso.compareTo(limite) < 0){
            ...
            situacao = "Peso m·ximo atingido.";

        }else {
            situacao = "Excesso de peso, haver· cobranÁa de adicional.";
        }
